...
import com.example.todomvvm.ui.todo.UpdateFragment;
import com.example.todomvvm.ui.todo.ViewFragment;
...
public class TodoListAdapter extends RecyclerView.Adapter<TodoListAdapter.TodoViewHolder> {
    ...
    class TodoViewHolder extends RecyclerView.ViewHolder {
        ...
        private TodoViewHolder(View itemView) {
            ...
            viewBtn = itemView.findViewById(R.id.view_task);
            updateBtn = itemView.findViewById(R.id.update_task);
    ...
    public TodoListAdapter(TodoFragment context) {
